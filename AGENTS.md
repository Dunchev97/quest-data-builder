...
- **Интерактивные объекты (Chest, HELP, Exchanger) не упоминаются в текстах квестов как сюжетные элементы.** Они участвуют в крафтовых заданиях автоматически через `_R_` ресурсы и не должны быть "сердцевиной" квеста. Не делать квесты про "открыть сундук", "зажечь фонарь" или "наполнить обменник" — эти механики уже встроены в игру. Тексты квестов должны описывать бытовой/сюжетный конфликт, а не интерактивные объекты.
